...
public class ContainerWithMostWater {
    public static void main(String[] args) {
        ...
        // Arr of 1 element
        // [2] - height = 0, width = 0; height = 0 | we need at least two elements to form a bucket
     ...
     // s: O(1)
      static int containerWithMostWater(int[] arr) {
        ...
        // calculate the squere by selecting the smaller value as height and i + 1 - i as a width
        int maxWidth = 0;
     ...
     // 1 loop with two pointers at the beginning and at the end moving towards each other
     // Moving only the side of lower height because its potential square will only be less than current 
     ...
     // From what is evident, square is goint to pare down as we move sides closer to each other
     // but if we move higher side closer we cannot find it a better counterpart (case with moving from 8)
     //
     // t: O(n)
     // s: O(1)
